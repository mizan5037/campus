                     ...
                     <h3></h3>
                       ...
                       <div class="details" style="background-color: #B1B1B1;">
                            <ul>
                                ...
                                <li>Published:{{date('M j,Y',strtotime($location->created_at))}}</li>
                        ...
                        <div class="content">
                         <p>location:{{$location->location}} <br><br>
                            Category:{{$location->bangla}} <br><br>
                            Salary:{{$location->salary}} <br><br>
                            Gender:{{$location->location}} <br><br>
                            Contact:{{$location->contact}} <br><br>
                    ...
                    <div class="widgets" style="background-color:gray;">
                        <h3>Location</h3>
                         ...
                         <select class="form-control" name="links" onchange="window.location.href=this.value;">
                             ...
                             @foreach($location_all as $loc)
                                <option value=""></option>
                               <option value="{{route('location.show',$loc->id)}}">{{$loc->location}}</option>
                             @endforeach
                           </select>
                    </div>
